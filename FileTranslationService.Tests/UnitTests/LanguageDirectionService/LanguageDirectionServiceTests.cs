...
namespace FileTranslationService.Tests.UnitTests.LanguageDirectionService
{
    public class LanguageDirectionServiceTests
    {
        ...
        public async Task CacheIsNotUsed_WhenCacheIsNotExpired()
        {
            ...
            var service = new Tilde.MT.FileTranslationService.Services.LanguageDirectionService(
                Mock.Of<ILogger<Tilde.MT.FileTranslationService.Services.LanguageDirectionService>>(),
